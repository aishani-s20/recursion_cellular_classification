...
def main():
    ...
    print("\nSaved final model: final_efficientnet_b3.pth")
    ...
    submission.to_csv('submission_efficientnet_b3.csv', index=False)
    print(f"Saved submission_efficientnet_b3.csv | Best val acc: {best_acc:.2f}%")
